...
from ._exceptions import UnifyError, APIStatusError
...
__all__ = ["Timeout", "Transport", "ProxiesTypes", "RequestOptions", "Unify", "AsyncUnify", "Client", "AsyncClient"]


class Unify(SyncAPIClient):
    # client options
    api_key: str
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous Unify client instance.

        This automatically infers the `api_key` argument from the `UNIFY_API_KEY` environment variable if it is not provided.
        """
        if api_key is None:
            api_key = os.environ.get("UNIFY_API_KEY")
        if api_key is None:
            raise UnifyError(
                "The api_key client option must be set either by passing api_key to the client or by setting the UNIFY_API_KEY environment variable"
            )
    ...
    @cached_property
    def with_raw_response(self) -> UnifyWithRawResponse:
        return UnifyWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> UnifyWithStreamedResponse:
        return UnifyWithStreamedResponse(self)
...
class AsyncUnify(AsyncAPIClient):
    # client options
    api_key: str
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async AsyncUnify client instance.
    ...
    @cached_property
    def with_raw_response(self) -> AsyncUnifyWithRawResponse:
        return AsyncUnifyWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> AsyncUnifyWithStreamedResponse:
        return AsyncUnifyWithStreamedResponse(self)
...
class UnifyWithRawResponse:
    _client: Unify

    def __init__(self, client: Unify) -> None:
        self._client = client
...
class AsyncUnifyWithRawResponse:
    _client: AsyncUnify

    def __init__(self, client: AsyncUnify) -> None:
        self._client = client
...
class UnifyWithStreamedResponse:
    _client: Unify
...
class AsyncUnifyWithStreamedResponse:
    _client: AsyncUnify
